...
At the end of the course, the students should know the specificity of time series data and should be able to use R to perform simple time series analysis by applying the techniques described in the course.
