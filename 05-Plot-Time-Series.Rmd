...
To learn something more about the graphical options made available by plot.ts, you can open and read the help page by using **?plot.ts**. The question mark followed by the name of a function opens the help page of that function.
