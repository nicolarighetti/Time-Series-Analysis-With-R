...
Besides plotting the results, it is possible to create a summary of the model, and by adding the argumetn "report" inside the function *summary*, a convenient explanations of the results is printed.
...
The authors of the package underline the importance of the statistical assumptions to get valid results, and about possible strategies to ascertain that the assumptions are met write the following advices:
