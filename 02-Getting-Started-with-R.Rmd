...
It is better to specify the appropriate type of data when importing the data sets (also notice, in the example below, that the data types "date" requires users to specify the format of the dates. In the example, dates are in the format Year-Month-Day, which is represented in R as "%Y-%m-%d").
