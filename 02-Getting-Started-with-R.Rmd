...
Below you can see the procedure to create, save, open a script, and run some simple commands.

![](videos/create-a-script.mov){width="80%"}
...
![](videos/import-data.mov){width="80%"}
