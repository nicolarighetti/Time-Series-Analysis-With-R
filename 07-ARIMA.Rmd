...
The cross-correlation applied to the original series results in a plot where everything seems to be correlated. The "real" correlation at lags $x_{t-3}$ and $x_{t-4}$ is not discernible at all.
